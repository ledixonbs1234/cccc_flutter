// Simple demo showing copy data functionality without Flutter dependencies
...
void main() {
  ...
  print('Total CCCD records: ${totalCCCD.length}');
  print('');
  ...
  for (int i = 0; i < totalCCCD.length; i++) {
    String line = totalCCCD[i].toCopyFormat(i + 1);
    buffer.writeln(line);
    print(line);
  }
  ...
  CCCDInfo testRecord = totalCCCD.first;
  print('Original data:');
  ...
  print('');
  print('=== Comparison with your expected format ===');
  print('Expected: 1\\t093211007653\\tTrình Quốc Hưng\\t19/03/2011\\tNam\\tDiễn Khánh Hoài Đức');
  print('Actual:   ${testRecord.toCopyFormat(1)}');
  print('Match: ${testRecord.toCopyFormat(1) == '1\t093211007653\tTrình Quốc Hưng\t19/03/2011\tNam\tDiễn Khánh Hoài Đức'}');
}
